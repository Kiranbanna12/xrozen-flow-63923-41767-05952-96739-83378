...
export const migration_001_initial_schema: Migration = {
  ...
  up: (db: Database.Database) => {
    ...
    // AI indexes
    db.exec('CREATE INDEX IF NOT EXISTS idx_ai_conversations_user_id ON ai_conversations(user_id)');
    db.exec('CREATE INDEX IF NOT EXISTS idx_ai_messages_conversation_id ON ai_messages(conversation_id)');
    db.exec('CREATE INDEX IF NOT EXISTS idx_ai_messages_created_at ON ai_messages(created_at)');
